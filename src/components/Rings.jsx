...
const Rings = ({position1, position2, position3, position4}) => {
  return (
    <>
      ...
      <div className={`absolute ${position1} w-[50rem] h-[50rem] border-[10rem] border-black/5 rounded-full opacity-60 animate-pulse shadow-[0_0_50px_#22c55e]`}></div>
      {/* Bottom Left Ring with Soft Glow */}
      <div className={`absolute ${position2} w-[50rem] h-[50rem] border-[97rem] border-black/5 rounded-full opacity-60 animate-pulse shadow-[0_0_50px_#22c55e]`}></div>
